...
export interface DetailAnswerCartItemProps {
	x: string | number;
	detail: {
		a: number;
		b: number;
...
interface DetailAnswerCartProps {
	data: DetailAnswerCartItemProps[];
}
export default function DetailAnswerCart({ data }: DetailAnswerCartProps) {
	return (
