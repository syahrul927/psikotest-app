...
export const KraeplinInvitationTableSchema = z.object({
  id: z.string(),
...
export type KraeplinInvitationTableProps = z.infer<
  typeof KraeplinInvitationTableSchema
> & {
  onDelete: (id: string) => void;
};

export const KraeplinInvitationStatus = [
  {
    value: "PENDING",
    label: "Pending",
    icon: CircleIcon,
