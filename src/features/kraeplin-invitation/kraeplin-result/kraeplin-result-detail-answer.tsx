...
export interface KraeplinResultDetailAnswerItemProps {
	x: string | number;
	detail: {
		a: number;
		b: number;
...
interface KraeplinResultAnswerProps {
	data: KraeplinResultDetailAnswerItemProps[];
}
export function KraeplinResultDetailAnswer({
	data,
}: KraeplinResultAnswerProps) {
	return (
