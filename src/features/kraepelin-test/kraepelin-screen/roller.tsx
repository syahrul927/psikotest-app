...
export interface KraepelinScreenRollerProps {
  display: RouterOutputs["kraepelinTest"]["getTemplate"];
  answer?: number;
  down: number;
  up: number;
}

export const KraepelinScreenRoller = ({
  display,
  answer,
  down,
  up,
}: KraepelinScreenRollerProps) => {
